...
class _BookRepository implements BookRepository {
  ...
  Future<GetBookListResponse> getBookList(
      {getBookListParams = const GetBookListParams()}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.addAll(getBookListParams?.toJson() ?? <String, dynamic>{});
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<GetBookListResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
